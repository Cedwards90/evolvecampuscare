...
const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: 'Manage Requests', href: '/requests/queue', icon: Users, roles: ['case_manager', 'org_admin'] },
      { label: 'Student Folders', href: '/students', icon: FolderOpen, roles: ['case_manager', 'admin', 'org_admin'] },
  ...
  },
  {
    ...
    label: 'Insights',
    items: [
      { label: 'Admin Dashboard', href: '/admin', icon: BarChart3, roles: ['admin', 'org_admin'] },
